...
function MerchantDetail({ merchantId }: MerchantDetailProps) {
  ...
  const handleEditBusinessDetails = () => {
    if (businessDetails) {
      ...
      // Create default business details using merchant name as legal name
      const defaultBusinessDetails: BusinessDetails = {
        id: 0, // Will be assigned by the backend
        merchantId: merchantId,
        legalName: merchant.name, // Use the merchant name as default legal name
        ein: null,
        businessType: null,
        industry: null,
        yearFounded: null,
      ...
      setEditedBusinessDetails(defaultBusinessDetails);
      setIsEditingBusiness(true);
    } else {
      toast({
        title: "Error",
        description: "Cannot create business details without merchant information",
        variant: "destructive"
      });
    }
  };
  ...
  return (
    <div className="bg-white shadow overflow-hidden sm:rounded-lg">
      ...
      {/* Business Details Section (always displayed) */}
      <div className="mt-6 mb-6">
        <div className="px-4 py-5 sm:px-6 border-t border-gray-200 flex justify-between items-center">
          ...
          <Button
            ...
            size="sm"
          >
            {businessDetails ? "Edit Business Info" : "Add Business Info"}
          </Button>
        </div>
        ...
        {businessDetails ? (
              ...
              <dl className="sm:divide-y sm:divide-gray-200">
                ...
                {businessDetails.addressLine1 && (
                  <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    ...
                    <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                      ...
                      {businessDetails.addressLine2 && `${businessDetails.addressLine2}<br />`}
                ...
                {businessDetails.phone && (
                  <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    ...
                    <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{businessDetails.phone}</dd>
                  </div>
                )}
                {businessDetails.websiteUrl && (
                  <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    ...
                    <dd className="mt-1 text-sm text-blue-600 sm:mt-0 sm:col-span-2">
                      <a href={businessDetails.websiteUrl} target="_blank" rel="noopener noreferrer" className="hover:underline">
                        {businessDetails.websiteUrl}
                      </a>
                    </dd>
                  </div>
                  ...
                  <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    ...
                    <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                      <pre className="whitespace-pre-wrap bg-gray-50 p-2 rounded text-xs overflow-auto max-h-40">
                        {(() => {
                          try {
                            const data = JSON.parse(businessDetails.verificationData);
          ...
          <div className="border-t border-gray-200 px-4 py-5 sm:p-0">
            <div className="text-center py-8">
              <p className="text-sm text-gray-500 mb-4">No business details available for this merchant.</p>
              <p className="text-sm text-gray-500">Click the "Add Business Info" button above to add details.</p>
            </div>
          </div>
        )}
      </div>
      ...
      {businessDetails && businessDetails.middeskBusinessId && (
        <div className="mt-6 mb-6">
          <div className="px-4 py-5 sm:px-6 border-t border-gray-200">
            <h3 className="text-lg leading-6 font-medium text-gray-900">Business Verification Reports</h3>
          </div>
      ...
      {plaidMerchant && plaidMerchant.originatorId && (
        <div className="mt-6 mb-6">
          <div className="px-4 py-5 sm:px-6 border-t border-gray-200">
            <h3 className="text-lg leading-6 font-medium text-gray-900">Plaid Asset Reports</h3>
          </div>
      ...
      <div className="mt-6 mb-6">
        ...
        <div className="border-t border-gray-200">
          <DueDiligenceReport merchantId={merchantId} />
        </div>
      </div>
            ...
            <div className="grid gap-4 py-4">
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <Input
                  ...
                  onChange={(e) => setEditedBusinessDetails({...editedBusinessDetails, legalName: e.target.value})}
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <Input
                  ...
                  onChange={(e) => setEditedBusinessDetails({...editedBusinessDetails, ein: e.target.value})}
                  className="col-span-3"
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <Input
                  ...
                  onChange={(e) => setEditedBusinessDetails({...editedBusinessDetails, businessType: e.target.value})}
                  className="col-span-3"
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <Input
                  ...
                  onChange={(e) => setEditedBusinessDetails({...editedBusinessDetails, industry: e.target.value})}
                  className="col-span-3"
                />
              </div>
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <Input
                  ...
                  onChange={(e) => setEditedBusinessDetails({...editedBusinessDetails, yearFounded: parseInt(e.target.value) || null})}
                  className="col-span-3"
                />
              </div>
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <Input
                  ...
                  onChange={(e) => setEditedBusinessDetails({...editedBusinessDetails, annualRevenue: parseInt(e.target.value) || null})}
                  className="col-span-3"
                />
              </div>
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <Input
                  ...
                  onChange={(e) => setEditedBusinessDetails({...editedBusinessDetails, addressLine1: e.target.value})}
                  className="col-span-3"
                />
              </div>
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <Input
                  ...
                  onChange={(e) => setEditedBusinessDetails({...editedBusinessDetails, addressLine2: e.target.value})}
                  className="col-span-3"
                />
              </div>
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <Input
                  ...
                  onChange={(e) => setEditedBusinessDetails({...editedBusinessDetails, city: e.target.value})}
                  className="col-span-3"
                />
              </div>
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <Input
                  ...
                  onChange={(e) => setEditedBusinessDetails({...editedBusinessDetails, state: e.target.value})}
                  className="col-span-3"
                />
              </div>
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <Input
                  ...
                  onChange={(e) => setEditedBusinessDetails({...editedBusinessDetails, zipCode: e.target.value})}
                  className="col-span-3"
                />
              </div>
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <Input
                  ...
                  onChange={(e) => setEditedBusinessDetails({...editedBusinessDetails, phone: e.target.value})}
                  className="col-span-3"
                />
              </div>
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <Input
                  ...
                  onChange={(e) => setEditedBusinessDetails({...editedBusinessDetails, websiteUrl: e.target.value})}
                  className="col-span-3"
                />
              </div>
            </div>
